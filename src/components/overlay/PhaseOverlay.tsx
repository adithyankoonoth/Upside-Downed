...
// Calculates opacity for a phase — clean fade in then fade out
...
// ── Body copy ────────────────────────────────────────────────────────────
function Body({ text, delay = 0 }: { text: string; delay?: number }) {
  return (
    <motion.p
      className="font-vt323 text-base md:text-xl text-ash/80 leading-relaxed max-w-[520px]"
...
function Tag({ text, color = "#ff1a1a" }: { text: string; color?: string }) {
  return (
    <p
      className="font-vt323 text-[10px] tracking-[0.25em] mt-3"
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center px-6">
      ...
      >
        <motion.p
          variants={fadeUp}
          className="font-vt323 text-[10px] md:text-xs tracking-[0.35em] text-rift/60 mb-6"
        >
          {s.eyebrow}
        </motion.p>
        ...
        <motion.h1
          ...
          style={{
            ...
            color: "#ff1a1a",
            textShadow: "0 0 60px #ff1a1aaa, 0 0 120px #ff1a1a44",
          }}
        >
          {s.title[0]}
          <br />
        ...
        <motion.div variants={fadeUp} className="mt-6 mb-4">
          <Divider color="#ff1a1a" />
        </motion.div>

        <motion.p
          variants={fadeUp}
          className="font-vt323 text-lg md:text-xl text-ash/80 max-w-md leading-relaxed"
        >
          {s.body}
        </motion.p>
        ...
        <motion.div
          variants={fadeUp}
          className="mt-8 flex items-end gap-[2px]"
        >
          {bars.map((b, i) => (
            <div
              key={i}
              className="w-[3px] bg-rift/70 rounded-full"
              style={{
                height: `${b.h}px`,
                boxShadow: "0 0 4px #ff1a1a88",
        ...
        <motion.p
          variants={fadeUp}
          className="font-vt323 text-[10px] tracking-[0.3em] text-rift/40 mt-4"
        >
          {s.tag}
        </motion.p>
      </motion.div>
    ...
    <div className="flex flex-col justify-center h-full px-6 md:px-16 lg:px-24">
      ...
      >
        <motion.div variants={fadeUp}>
          <Eyebrow text={s.eyebrow} color="#00c8ff" />
        </motion.div>

        <motion.div variants={fadeUp}>
          <Title lines={s.title} color="#ffffff" size="medium" />
        </motion.div>

        <motion.div variants={fadeUp} className="my-4">
          <Divider color="#00c8ff" />
        </motion.div>

        <motion.p
          variants={fadeUp}
          className="font-vt323 text-base md:text-xl text-ash/80 leading-relaxed max-w-xl"
        >
          {s.body}
        </motion.p>
        ...
        >
          {["HAWKINS LAB", "DR. BRENNER", "SENSORY DEPRIVATION", "SUBJECT 011", "PSYCHIC CONDITIONING"].map(
            (chip) => (
              <span
                key={chip}
                className="font-vt323 text-[10px] tracking-widest px-2 py-1"
                style={{
                  color: "#00c8ff88",
...
function PhaseGate() {
  ...
  return (
    <div className="flex flex-col justify-center h-full items-end px-6 md:px-16 lg:px-24">
      ...
      >
        <motion.div variants={fadeUp}>
          <Eyebrow text={s.eyebrow} color="#ff1a1a" />
        </motion.div>
        ...
        <motion.div variants={fadeUp} className="flex justify-end my-4">
          <Divider color="#ff1a1a" />
        </motion.div>

        <motion.p
          variants={fadeUp}
          className="font-vt323 text-base md:text-xl text-ash/80 leading-relaxed"
        >
          {s.body}
        </motion.p>
        ...
        >
          {["NOV 6 1983", "ISOLATION TANK", "DEMOGORGON", "DIMENSIONAL TEAR", "THE GATE OPENS"].map(
            (chip) => (
              <span
                key={chip}
                className="font-vt323 text-[10px] tracking-widest px-2 py-1"
...
function PhaseVecna() {
  ...
  return (
    <div className="flex flex-col justify-center h-full px-6 md:px-16 lg:px-24">
      ...
      >
        <motion.div variants={fadeUp}>
          <Eyebrow text={s.eyebrow} color="#8b0000" />
        </motion.div>
        ...
        <motion.div
          variants={fadeUp}
          className="mt-6 grid grid-cols-2 gap-2 max-w-sm"
        >
          {[
            ...
            >
              <p className="font-vt323 text-[9px] tracking-widest" style={{ color: "#8b000099" }}>
                {label}
              </p>
              <p className="font-vt323 text-sm" style={{ color: "#cc000099" }}>
                {val}
              </p>
            </div>
          ))}
...
function PhaseTrapped() {
  ...
  return (
    <div className="flex flex-col justify-center h-full items-end px-6 md:px-16 lg:px-24">
      ...
      >
        <motion.div variants={fadeUp}>
          <Eyebrow text={s.eyebrow} color="#39ff14" />
        </motion.div>

        <motion.div variants={fadeUp}>
          <Title lines={s.title} color="#39ff14" size="medium" />
        </motion.div>

        <motion.div variants={fadeUp} className="flex justify-end my-4">
          <Divider color="#39ff14" />
        </motion.div>
        ...
        <motion.div variants={fadeUp} className="mt-6 space-y-2">
          {[
            ...
            <div key={label} className="flex items-center gap-3 justify-end">
              ...
              <span className="font-vt323 text-xs w-10 text-right" style={{ color }}>
                {val}{unit}
              </span>
            </div>
          ))}
...
// ─────────────────────────────────────────────────────────────────────────────
// PHASE 6 — CLIMAX + HACKATHON REVEAL
// ─────────────────────────────────────────────────────────────────────────────
    ...
    <div className="flex flex-col items-center justify-center h-full px-4 md:px-8 text-center">
      ...
      <motion.h2
        ...
        style={{
          ...
          color: "#ff1a1a",
          textShadow: "0 0 40px #ff1a1aaa, 0 0 100px #ff1a1a44",
        }}
      >
        THE SHADOW STORM
        <br />
      ...
      >
        ...
        {typed.map((line, i) => {
          const isWarning = line.includes("CRITICAL") || line.includes("LETHAL") || line.includes("OMEGA");
          const isDivider  = line.startsWith("——");
          const isLast     = i === lines.length - 1;
          return (
            <div key={i} className="flex gap-2 mb-1 font-vt323 text-sm md:text-base">
              {!isDivider && (
                <span className="text-rift/50 flex-shrink-0">
                  {i < 5 ? ">>>" : "   "}
                </span>
              )}
              <span
                style={{
                  ...
                  textShadow: isWarning ? "0 0 8px #ff1a1a88" : isDivider ? "none" : "0 0 6px #00c8ff44",
                }}
              >
                {line}
                {i === lineIdx && !done && (
                  <span className="cursor-blink" style={{ color: "#00c8ff" }}>█</span>
                )}
              </span>
            </div>
          );
...
export function PhaseOverlay({ scrollProgress: p }: PhaseOverlayProps) {
  ...
  // One key each so AnimatePresence unmounts cleanly
  return (
    <>
      <AnimatePresence>
        {op1 > 0 && (
          <PhaseShell key="p1" opacity={op1}>
            <PhaseSignal />
          </PhaseShell>
        )}
      </AnimatePresence>
      ...
      <AnimatePresence>
        {op6 > 0 && (
          <PhaseShell key="p6" opacity={op6}>
            <PhaseClimax active={p > 0.90} />
          </PhaseShell>
        )}
      </AnimatePresence>
    </>
...
// Wrapper that carries the opacity and pointer-events
function PhaseShell({
  children,
  opacity,
}: {
